...
function ValidFoundCourses() {
    ...
    //var campus = $('#val_campus').val();JABB
    ...
    //if(campus==""){showNotification('El campo es necesario', 'Campus'); return;}JABB
    ...
    setCursosfound_SC(titulo,instructor,periodo,'UFT',atributos,dias,hora,minuto,time,desc_periodo,carrera);
